...
- `projects/{name}/memory/discussion/decision-notes.md`
- `projects/{name}/memory/discussion/handoff.md`
...
- 긴 대화 중간중간 합의와 열린 질문을 누적한다.
- handoff로 올릴 정도는 아니지만 잊으면 안 되는 내용을 남긴다.
...
- 유저와 합의된 실행 변경을 Manager가 즉시 반영할 수 있게 전달한다.
